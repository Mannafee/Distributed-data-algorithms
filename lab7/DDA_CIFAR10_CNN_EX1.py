...
save_model_path = r'C:\Users\manna\Documents\GitHub\CIFAR10-img-classification-tensorflow\graph_EX1'

print('Training...')
loss_over_time = np.zeros(epochs)
with tf.Session() as sess:
    merged_summary_op = tf.summary.merge_all()
    summary_writer = tf.summary.FileWriter(r"C:\Users\manna\Documents\GitHub\CIFAR10-img-classification-tensorflow\graph_EX1", sess.graph)
...
#    axs.plot(time_train,rmse_train,label='rmse_train')
    axs.plot(epoch_1,accuracy_history,label='validation_accuracy',color='red')
    plt.legend()
    plt.show()
